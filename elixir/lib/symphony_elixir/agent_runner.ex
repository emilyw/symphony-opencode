defmodule SymphonyElixir.AgentRunner do
  ...
  require Logger
  alias SymphonyElixir.{Codex.AppServer, Config, Linear.Issue, Opencode.Server, PromptBuilder, Tracker, Workspace}
  ...
  defp do_run_opencode_turns(
    ...
    with {:ok, turn_result} <-
           Server.run_turn(
             ...
             prompt,
             issue,
             on_message: codex_message_handler(agent_update_recipient, issue)
           ) do
